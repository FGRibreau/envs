...
## [Unreleased]
## [0.2.0](https://github.com/FGRibreau/envs/compare/v0.1.0...v0.2.0) - 2026-06-03

### Added

- *(cli)* Explain the why, not just the how, on first run

- *(daemon)* Drive consent popup for non-TTY callers
...
- *(daemon)* Find envs-prompt next to envsd, and make restart survive rebuilds
